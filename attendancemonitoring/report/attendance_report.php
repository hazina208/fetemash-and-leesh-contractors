          ...
          <form action="index.php?view=attendance" method="POST" >
               ...
               <input class="Search_date date_pickerfrom" size="11" 
                  ...
                  <input class="Search_date date_pickerfrom" size="11" 
                   ...
                   <select name="Attendance"  class="Search_partylist Attendance"> 
                       ...
                       <?php   
                          $mydb->setQuery("SELECT c.StudentID, c.`Firstname`, c.`Lastname`, c.`Middlename`
                                  FROM  `tblstudent` c, `tbltimetable` d WHERE c.StudentID=d.StudentID");
           ...
           <div class="center wow fadeInDown"> 
                ...
                <p class="lead"> <?php echo isset($_POST['attenddate']) ? 'As of '. $_POST['attenddate'] : '' ; ?><br/>
                               <?php echo isset($_POST['Attendance']) ?  'Employee:'.  $_POST['Attendance'] : '' ; ?><br/>
                  ...
                  <tbody>
                    <?php  
                      ...
                      $mydb->setQuery("SELECT * FROM `tbltimetable` t, `tblstudent` s
                               ...
                               AND s.`Firstname` ='{$_POST['Attendance']}' AND Date(`AttendDate`) ='{$attenddate}' ORDER BY TimeTableID desc");

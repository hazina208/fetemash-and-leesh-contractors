                ...
                <div class="features">
                           ...
                           <form class="form-horizontal span6 wow fadeInDown" action="controller.php?action=edit" method="POST"> 
                              ...
                              <div class="col-md-8">
                                ...
                                "COURSE_NAME">Position:</label>

                                <div class="col-md-8">
                                  
                                   <input class="form-control input-sm" id="COURSE_NAME" name="COURSE_NAME" placeholder=
                                      "Position" type="text" value="<?php echo $singlecourse->CourseCode; ?>"  onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">
                                </div>
                              </div>
                            </div> 
                              ...
                              <div class="col-md-8">
                                ...
                                <div class="col-md-8">
                                   ...
                                   <input class="form-control input-sm" id="COURSE_DESC" name="COURSE_DESC" placeholder=
                                      "Position Description" type="text" value="<?php echo $singlecourse->Description; ?>" required  onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">
                                </div>
                              </div>
                            </div>

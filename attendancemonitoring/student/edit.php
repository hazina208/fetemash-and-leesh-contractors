                    ...
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8"> -->
                         <input class="form-control input-sm" id="StudentID" name="StudentID" placeholder=
                            "Employee ID" type="hidden" value="<?php echo $s_student->ID;?>">

                         <input class="form-control input-sm" id="IDNO" name="IDNO" placeholder=
                            "Employee ID" type="hidden" value="<?php echo $s_student->StudentID;?>"  onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">
                    <!--   </div>
                    </div>
                  </div>
 -->

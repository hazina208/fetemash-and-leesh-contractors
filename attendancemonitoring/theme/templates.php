...
<head>
    ...
    <title>Home | Employee and Attendance Management System</title>
...
<ul>
   ...
   <li  class="<?php echo (currentpage_public() == 'course') ? "active" : false;?>"><a href='<?php echo web_root; ?>course/'><i class="fa fa-graduation-cap"></i> Positions</a></li>

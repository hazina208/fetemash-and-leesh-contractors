            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav mod-menu" style="font-size:13px;"  > 
                        <li hover="ff9933" class="<?php echo (currentpage_public() == 'student') ? "active" : false;?>">  <a href="<?php echo web_root; ?>student/">Employees</a></li> 
                        ...
                        <li class="dropdown"> 
                            ...
                            <ul class="dropdown-menu"   style="" > 
                                <li class="<?php echo (currentpage_public() == 'course') ? "active" : false;?>"><a href="<?php echo web_root; ?>course/index.php">Positions</a></li>

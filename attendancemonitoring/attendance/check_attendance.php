                      ...
                      <div class="col-sm-7 wow fadeInDown"> 
                        ...
                        <div class="col-md-8"> 
                          	  ...
                          	  <ul class="list-group">
                                  ...
                                  <li class="list-group-item text-right"><span class="pull-left">EMPLOYEE NO</span><input class="StudentID" type="text" id="StudentID"></li>
                                  <li class="list-group-item text-right"><span class="pull-left">Name</span><label id="name">NONE</label> </li>
                                  <li class="list-group-item text-right"><span class="pull-left">POSITION</span><label id="course">NONE</label></li>
...
<h2>
 ...
 <center>
   <footer>        
    <p  style="color:#fff;font-size: 12px">Attendance Monitoring System  Copyright </p>  
    </footer>
</center>

    ...
    ?>
      <tr>
        ...
        if($row['project_type'] == '1'){
         ...
         ?><input type="hidden" id="<?php echo $id ?>" value="<?php echo $row['project_type'] ?>"></td>
        <td style="text-transform:capitalize" class="text-center"><center><a onclick="update_div()"><i class="fa fa-pencil"></i> edit</a></center></td>
       </tr>

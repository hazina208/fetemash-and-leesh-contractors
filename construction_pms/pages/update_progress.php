		...
		<tbody>
			...
			while($row2 = mysqli_fetch_assoc($query)){
			 ...
			 <tr>
			 	...
			 	<td>
					 <center><a href="#progess<?php echo $row2['prog_id'] ?>" data-toggle="modal"><i class="fa fa-pencil"> </i>Edit</a></center><br>
					 <center><a href="delprojectpartition.php?prog_id=<?=$row2['prog_id']?>"> <i class="fa fa-trash"> </i> Del</a></center>
			    </td>
			 </tr>

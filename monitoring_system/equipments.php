            ...
            <div class="card-body">
              ...
              <?php
                  if(isset($_SESSION['delete']))
                   {
                      echo $_SESSION['delete'];//deleting session msg
                      unset($_SESSION['delete']);//failing sesion message
                   }
              ?>
                            ...
                            echo '<tr>';
                             ...
                             echo '<td>'. $row['category'].'</td>';
                              ...
                              //  echo '<td>'. $row['available_quantity'].'</td>';
                               ...
                               ?>
                               <td>
                               <a type="button" class="btn btn-danger fas fa-trash" href="delequip.php?equip_id=<?=$row['equip_id']?>">Delete</a>
                               </td>
                               <?php
                ...
                <div class="modal-content" style="width: 130%">
                  ...
                  <div class="modal-body">
                          ...
                          <form method="POST" action="#">
                            ...
                            <select name="status" class="form-control" id="selectType">
                            ...
                            <div class="form-group">
                            <div class="form-label-group">
                            <input type="number" id="inputQty" value="1"  class="form-control" placeholder="Quantity" name="qty" autofocus="autofocus" required>
...
date_default_timezone_set("Asia/Manila"); 
 ...
 $remarks="equipment $name was Added"; 
  $query = "INSERT INTO equipments(uniquec,name,category,status,quantity,available_quantity)
                VALUES ('".$code."','".$name."','".$category."','".$status."', '".$qty."','".$qty."')";
                mysqli_query($db,$query)or die (mysqli_error($db));
mysqli_query($db,"INSERT INTO logs(action,date_time) VALUES('$remarks','$date1')")or die(mysqli_error($db));
                ?>
                <script type="text/javascript">

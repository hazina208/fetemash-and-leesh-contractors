                            ...
                            echo '<tr>';
                             ...
                             echo '<td>'. $row['tool_type'].'</td>';
                              echo '<td>'. $row['quantity'].'</td>';
                               ...
                               echo 
                               '<td>
                               <a type="button" class="btn btn-sm btn-warning fa fa-edit fw-fa" href="#" data-toggle="modal" data-target="#UpdateTool'.$row['tool_id'].'">Edit</a>
                               
                               </td>';

                               ?>
                               <td>
                               <a type="button" class="btn btn-danger fas fa-trash" href="del2.php?tool_id=<?=$row['tool_id']?>">Delete</a>
                               </td>
                               <?php
